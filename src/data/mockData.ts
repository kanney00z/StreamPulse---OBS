...
export const CHAT_THEMES: ChatThemeConfig[] = [
  {
    id: 'multistream-pill-dynamic',
    name: 'Multistream Floating Pill (ตามคลิปวิดีโอ 100%)',
    tagline: 'วิเจ็ตแชท Multistream แคปซูลลอย ออร่าสีแยกตามแพลตฟอร์ม Twitch, YouTube, Kick, TikTok พร้อมวงแหวนโปรไฟล์และเวลา (ตามคลิปเป๊ะ)',
    badge: 'MULTISTREAM 🌐',
    isMultistream: true,
    multistreamVariant: 'dynamic',
    category: 'multistream',
    previewBg: 'bg-[#121322] border border-fuchsia-500/50 shadow-[0_0_20px_rgba(217,70,239,0.45)]',
    containerClass: 'space-y-3 font-sans',
    messageCardClass: () =>
      'relative backdrop-blur-xl px-4 py-2.5 rounded-2xl border border-white/10 bg-[#121322]/85 shadow-[0_8px_24px_rgba(0,0,0,0.7)]',
    usernameClass: 'font-bold text-white text-xs sm:text-sm',
    textClass: 'text-neutral-100 text-xs sm:text-sm leading-relaxed',
    avatarShape: 'circle',
    accentBorder: 'border-fuchsia-500/40',
  },
  {
    id: 'multistream-compact-pill',
    name: 'Multistream Compact Pill (ไม่แสดงโปรไฟล์)',
    tagline: 'วิเจ็ตแชทแคปซูลสไตล์มินิมอลกระทัดรัด (เหมือนฝั่งซ้ายของคลิป) ประหยัดพื้นที่หน้าจอสตรีม',
    badge: 'COMPACT 📱',
    isMultistream: true,
    multistreamVariant: 'compact',
    category: 'multistream',
    previewBg: 'bg-[#121322] border border-cyan-500/50 shadow-[0_0_18px_rgba(6,182,212,0.4)]',
    containerClass: 'space-y-2.5 font-sans',
    messageCardClass: () =>
      'relative backdrop-blur-xl px-3.5 py-2 rounded-2xl border border-white/10 bg-[#121322]/85 shadow-[0_6px_20px_rgba(0,0,0,0.65)]',
    usernameClass: 'font-bold text-white text-xs',
    textClass: 'text-neutral-100 text-xs leading-relaxed',
    avatarShape: 'circle',
    accentBorder: 'border-cyan-500/40',
  },
  {
    id: 'multistream-twitch-purple',
    name: 'Multistream Twitch Magenta',
    tagline: 'สไตล์แคปซูลโทรม่วงมาเจนต้า Twitch Shapiadsr พร้อมโลโก้ Twitch',
    badge: 'TWITCH 💜',
    isMultistream: true,
    multistreamVariant: 'twitch',
    category: 'multistream',
    previewBg: 'bg-[#121322] border border-fuchsia-500/50 shadow-[0_0_18px_rgba(217,70,239,0.4)]',
    containerClass: 'space-y-3 font-sans',
    messageCardClass: () =>
      'relative backdrop-blur-xl px-4 py-2.5 rounded-2xl border border-fuchsia-500/30 bg-[#121322]/85 shadow-[0_0_20px_rgba(217,70,239,0.3)]',
    usernameClass: 'font-bold text-white text-xs',
    textClass: 'text-neutral-100 text-xs sm:text-sm',
    avatarShape: 'circle',
    accentBorder: 'border-fuchsia-500/40',
  },
  {
    id: 'multistream-kick-green',
    name: 'Multistream Kick Neon Green',
    tagline: 'สไตล์แคปซูลโทนเขียวนีออน Kick KickViewer พร้อมโลโก้ K นีออนเด่นชัด',
    badge: 'KICK 🟢',
    isMultistream: true,
    multistreamVariant: 'kick',
    category: 'multistream',
    previewBg: 'bg-[#121322] border border-emerald-500/50 shadow-[0_0_18px_rgba(34,197,94,0.4)]',
    containerClass: 'space-y-3 font-sans',
    messageCardClass: () =>
      'relative backdrop-blur-xl px-4 py-2.5 rounded-2xl border border-emerald-500/30 bg-[#121322]/85 shadow-[0_0_20px_rgba(34,197,94,0.3)]',
    usernameClass: 'font-bold text-white text-xs',
    textClass: 'text-neutral-100 text-xs sm:text-sm',
    avatarShape: 'circle',
  ...
  {
    id: 'multistream-tiktok-cyan',
    name: 'TikTok Live Cyan Pill (สำหรับสตรีมเมอร์ติ๊กต็อก)',
    tagline: 'สไตล์แคปซูลแชท TikTok Live โทนฟ้าคราม ออร่าเรียบหรู ตามคลิป ไม่แสดงคำว่า TikTok ซ้ำซ้อน',
    badge: 'TIKTOK 🎵',
    isMultistream: true,
    multistreamVariant: 'tiktok',
    category: 'multistream',
    previewBg: 'bg-[#121322] border border-cyan-500/50 shadow-[0_0_18px_rgba(6,182,212,0.4)]',
    containerClass: 'space-y-3 font-sans',
    messageCardClass: () =>
      'relative backdrop-blur-xl px-4 py-2.5 rounded-2xl border border-cyan-500/30 bg-[#121322]/85 shadow-[0_0_20px_rgba(6,182,212,0.3)]',
    usernameClass: 'font-bold text-white text-xs',
    textClass: 'text-neutral-100 text-xs sm:text-sm',
    avatarShape: 'circle',
    accentBorder: 'border-cyan-500/40',
  ...
  {
    id: 'multistream-youtube-red',
    name: 'Multistream YouTube Rose',
    tagline: 'สไตล์แคปซูลโทนแดงกุหลาบ YouTube Emely พร้อมปุ่ม Play',
    badge: 'YOUTUBE 🔴',
    isMultistream: true,
    multistreamVariant: 'youtube',
    category: 'multistream',
    previewBg: 'bg-[#121322] border border-rose-500/50 shadow-[0_0_18px_rgba(244,63,94,0.4)]',
    containerClass: 'space-y-3 font-sans',
    messageCardClass: () =>
      'relative backdrop-blur-xl px-4 py-2.5 rounded-2xl border border-rose-500/30 bg-[#121322]/85 shadow-[0_0_20px_rgba(244,63,94,0.3)]',
    usernameClass: 'font-bold text-white text-xs',
    textClass: 'text-neutral-100 text-xs sm:text-sm',
    avatarShape: 'circle',
...
export const INITIAL_CHAT_MESSAGES: ChatMessage[] = [
  ...
  },
  {
    ...
    message: 'Be respectful in chat please.',
  ...
  },
  {
    ...
    message: 'Just followed, hi everyone!',
    timestamp: Date.now() - 7000,
    platform: 'multistream',
    isEvent: true,
    eventType: 'follow',
    eventText: 'NewFollower Just followed, hi everyone!',
    color: '#3b82f6',
  },
  {
    id: 'chat-vid-9',
